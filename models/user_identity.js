 ...
 */
module.exports = function (UserIdentity, napp) {

    /**
     * Log in with a third-party provider such as Weibo or Weixin.
     *
    ...
    function profileToUser(provider, profile) {
        ...
        if (!email) {
            // Fake an e-mail
            email = (profile.username || profile.id) + '@ollo.'
