...
/**
 * Credentials associated with the Ollo client application, such as oAuth 2.0
 * client ID/secret, or SSL keys
 *
 * @param{String} provider: The auth provider name, such as weibo, weixin, meituan
...
module.exports = function (ApplicationCredential) {
    ...
    /**
     * Link a third-party application credential with the Ollo application.
     * @param {String} appId The Ollo application iID.
    ...
    ApplicationCredential.link = function (appId, provider, authScheme, credentials, cb) {
        ApplicationCredential.findOne({where: {
            appId: appId,
            provider: provider
